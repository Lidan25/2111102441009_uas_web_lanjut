...
class ArtikelSerializer(serializers.ModelSerializer):
    Kategori = serializers.PrimaryKeyRelatedField(queryset=User.objects.all())
    ...
    class Meta:
        model = Artikel
        fields = [
            'id','judul','isi','kategori', 'kategori_detail', 'author', 'author_detail','thumbnail','created_at','slug']
